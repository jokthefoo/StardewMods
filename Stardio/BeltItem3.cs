...
[XmlType("Mods_Jok_BeltItem3")]
public class BeltItem3 : BeltItem
{
    [XmlIgnore]
    public static int Belt3Anim = 0;
    [XmlIgnore]
    public static int belt3AnimUpdateCountdown = 0;
    ...
    public BeltItem3(string itemid)
        : this()
    {
        ItemId = itemid;
        ReloadData(itemid);
    ...
    protected override void GetOneCopyFrom(Item source)
    {
        ...
        if (source is BeltItem3 beltFrom)
        {
